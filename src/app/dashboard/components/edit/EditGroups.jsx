  ...
  return (
    ...
    >
      ...
      <PanelEditDash edit={edit} setEdit={setEdit}>
        <p className="relative flex flex-col items-center w-full gap-[15px] rounded-xl text-[16px] font-semibold mb-[20px]">Editar Grupo</p>
        ...
        <div
          className={clsx("mt-[30px] flex flex-row justify-between w-full lg:w-[337px] lg:gap-[15px] mx-auto", {
        ...
        <div className={clsx("mt-[20px] w-full lg:w-[337px] lg:gap-[15px] mx-auto", { hidden: buttonDelete === false })}>
